		...
		<Layout title='Page Not Found | Othmane Lamnabhi'>
			<section className='bg-custom-light-pattens-blue px-8 pt-8 text-center dark:bg-custom-dark-motorcycle-black'>
				<div className='block'>
					...
					<Link href={"/"}>
						<a className='group mt-5 inline-block space-x-1 rounded-sm bg-custom-light-dodger-blue px-8 py-4 font-bold text-custom-dark-off-by-one duration-300 ease-out hover:scale-105 dark:bg-custom-dark-3-days-ecchymose'>
							<FontAwesomeIcon
				...
				<div className='mt-8 sm:mx-auto sm:w-2/3'>
					<Image
						src='/images/othmane_lamnabhi_headshot_404_optimized.webp'
