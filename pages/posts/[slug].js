...
// Preprocess markdown content to remove align="left" from images
function preprocessMarkdown(content) {
	return content.replace(/!\[(.*?)\]\((.*?)\s+align="left"\)/g, "![$1]($2)");
}
			...
			<article className='mx-8 my-12'>
				...
				<div
					...
					dangerouslySetInnerHTML={{
						__html: md().render(preprocessMarkdown(postData.content)),
					}}
				/>
			</article>
		</Layout>
